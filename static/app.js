function select_twitterData() {
    ...
    document.getElementById("twitter_options").innerHTML = '<div class="box-background box-padding"><label for="eventSelect">Select Twitter Data Visualization</label><select id="eventSelect" onchange="selectViz(this.value)">\
    <option value="viz1">Visual 1</option><option value="viz2">Visual 2</option><option value="viz3">Visual 3</option></select></div>'
...
function select_financeData() {
    ...
    <option value="cancel">Trump Cancels North Korea Summit</option><option value="reon">Trump Reopens North Korea Summit</option><option value="summitday">Day of The North Korea Summit</option>\
    ...
    <option value="dataset1">DOW</option><option value="dataset2">S&P 500</option>\
    </select></div>';
}
